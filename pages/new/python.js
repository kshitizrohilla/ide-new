...
const NewPython = ({ session }) => {
  ...
  return (
    <div className="bg-gradient-to-b from-slate-800 to-black flex items-center justify-center h-screen flex-col">
      <Image alt="C++ Logo" className="mb-2" src="https://www.gstatic.com/monospace/231115/logo_python.svg" width={50} height={50} />
      <h1 className="text-white font-medium text-xl mb-2">Create new Python workspace</h1>
